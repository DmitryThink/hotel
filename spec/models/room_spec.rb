...
RSpec.describe Room, type: :model do
  context 'with two rooms' do
    before(:all) do
      ...
      @room1 = Room.create!(id:1, number: 1, number_of_people: 3, price: 900, type_of_room: @type_of_room )
      @room2 = Room.create!(id:2, number: 2, number_of_people: 3, price: 900, type_of_room: @type_of_room )
