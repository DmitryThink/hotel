...
function distributeHeight(els, availableHeight, shouldRedistribute) {
    ...
    var flexHeights = []; // actual stylesheets height
    var usedHeight = 0;
...
var EventDefMutation = /** @class */ (function () {
    ...
    EventDefMutation.createFromRawProps = function (eventInstance, rawProps, largeUnit) {
        ...
        EventDef_1.default.copyVerbatimStandardProps(standardProps, // scr
    ...
    */
    EventDefMutation.prototype.mutateSingle = function (eventDef) {
        ...
        if (this.verbatimStandardProps) {
            SingleEventDef_1.default.copyVerbatimStandardProps(this.verbatimStandardProps, // scr
            eventDef // dest
            );
        }
        // can't undo
...
var ParsableModelMixin = /** @class */ (function (_super) {
    ...
    ParsableModelMixin.copyVerbatimStandardProps = function (src, dest) {
        ...
        var propName;
        for (propName in map) {
            if (src[propName] != null && // in the scr object?
