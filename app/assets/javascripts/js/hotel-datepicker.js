...
var HotelDatepicker = function HotelDatepicker(input, options) {
	...
	this.i18n = opts.i18n || {
		...
		'day-names': ['Воскресение', 'Понедельник', 'Вторник', 'Среда', 'Четверг', 'Пятница', 'Суббота'],
		...
		'info-more': 'Выберите диапазон дат как минимум 1 ночь',
		'info-more-plural': 'Выберите диапазон дат не менее %d ночей',
		'info-range': 'Выберите диапазон дат между %d и %d ночей',
